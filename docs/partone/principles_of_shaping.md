...
> فصل ۲ از کتاب شیپ‌آپ
> منبع: [Shape Up - Principles of Shaping](https://basecamp.com/shapeup/1.1-chapter-02)

![کار شیپ‌شده چیزی میان کار مفهومی و کار صریح است](../assets/images/shapeup/1.1-chapter-02/levels_of_abstraction.jpeg)
...
![اسکچ زمخت از مفهوم جدول نقطه‌ای](../assets/images/shapeup/1.1-chapter-02/calendar_sketch.png)
...
![اسکرین‌شاتی از جدول نقطه‌ای زمانی که راه‌اندازی شد](../assets/images/shapeup/1.1-chapter-02/calendar_screenshot.png)
